...
public class PasajeroWS {
    ...
    public int getCantidadDePasajerosPorContrato(String cod) throws MalformedURLException, IOException{
        //Ruta completa del host+parametros a enviar
        String rutaCompleta = urlWS + "/getPasajerosPorContrato?cod=" + cod;
        ...
        while ((output = br.readLine()) != null) {
            ...
            cantidad = Integer.parseInt(output);
